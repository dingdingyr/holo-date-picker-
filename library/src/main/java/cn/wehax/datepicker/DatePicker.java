...
import cn.wehax.datepicker.calendarview.CalendarView;
import cn.wehax.datepicker.numberpicker.NumberPicker;
...
public class DatePicker extends FrameLayout {
    ...
    public DatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        // month
        Log.e("dss", "mMonthSpinner===============================");
        mMonthSpinner = (NumberPicker) findViewById(R.id.month);
        mMonthSpinner.setFormatter(new NumberPicker.Formatter() {
            @Override
            public String format(int value) {
                Log.e("dss", "mMonthSpinner.setFormatter");
                return String.format("%dMonth", value);
            }
        });
        ...
        // year
        Log.e("dss", "mYearSpinner===============================");
        mYearSpinner = (NumberPicker) findViewById(R.id.year);
        mYearSpinner.setFormatter(new NumberPicker.Formatter() {
            @Override
            public String format(int value) {
                Log.e("dss", "mYearSpinner.setFormatter");
                return String.format("%dYear", value);
            }
        });
